// Deidra Driscoll & Chris MorelOrtiz
// CSI-100-02: The Joy of Computing
// October 2020
// This program is a game, where the "hero" enters a hospital. When inside, an NPC will remind the user to put a mask on. It is up the user to find the keycard, go back to the closet, and
// put a mask on. Once the mask is on the user can go about their day between the two rooms.
